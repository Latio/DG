...
c_VertLimit2d(double *fphys_, double *x_, double *y_, double *xc_, double *yc_, double *vx_, double *vy_, double *fvert_, double *fvmin_, double *fvmax_, double  *cvar_, double *EToV_, double *Fmask_, int *Np_, int *Nv_, int *K_, int *Nfp_)
{

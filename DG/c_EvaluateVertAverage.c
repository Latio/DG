...
//
//void c_EvaluateVertAverage(double *cvar_, int *Nv_, double *Nvc_, double *VToM_, double *VToK_, double *VToW_, double *fvert_, double *fvmin_, double *fvmax_)
//{
//
//	int Nv = *Nv_;
...
//
//	/* get dimensions */
//	int maxNk = mxGetM(prhs[3]); // maximum number of cells connecting to one vertex
